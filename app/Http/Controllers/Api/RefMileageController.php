...
use App\Models\RefMileage;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Gate;


class RefMileageController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $result = RefMileage::create($param);
        if($result)
    ...
    public function update(Request $request)
    {
        ...
        $result = RefMileage::where('id',$param['id'])->update(['name'=>$param['name']]);
        if($result)
    ...
    public function delete(Request $request)
    {
        ...
        $result=RefMileage::where('id',$param['id'])->delete();
