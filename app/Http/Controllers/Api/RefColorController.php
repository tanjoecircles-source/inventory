...
class RefColorController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $valid=validator($request->only('name','code','hexa'), [
            'name'=>'required',
            'code'=>'required',
            'hexa'=>'required'
        ]);
        ...
        $param = request()->only('name','code','hexa');
        $result = RefColor::create($param);
        if($result)
    ...
    public function update(Request $request)
    {
        ...
        $valid=validator($request->only('name','code','hexa','id'), [
            'name'=>'required',
            'code'=>'required',
            'hexa'=>'required',
            'id'=>'required'
        ...
        $param = request()->only('name','code','hexa','id');
        $result = RefColor::where('id',$param['id'])->update(['name'=>$param['name']]);
        if($result)
    ...
    public function delete(Request $request)
    {
        ...
        $result=RefColor::where('id',$param['id'])->delete();
