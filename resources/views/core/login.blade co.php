        ...
        <div class="col-lg-4 mx-auto">
            ...
            <div class="text-center">
                ...
                <a class="btn btn-block btn-lg btn-outline-primary font-weight-normal" href="{{ url('register') }}"><i class="fe fe-edit-3"></i> Daftar Sekarang</a>
                 --}}
                <div class="font-weight-normal fs-15 mb-2 mt-5">Terjadi kendala pada akunmu?</div>
                <div class="row mt-2 mb-5">
                    <div class="col-6 text-right pr-1">
                        <a class="btn btn-sm btn-default" href="{{ url('forgot-password') }}"><i class="fe fe-help-circle"></i> Lupa Password</a>
                    </div>
                    <div class="col-6 text-left pl-1">
                        <a class="btn btn-sm btn-default flex-fill" href="{{ url('account-verification') }}"><i class="fe fe-info"></i> Gagal Verifikasi</a>
                    </div>
                </div>
            </div>
        </div>
