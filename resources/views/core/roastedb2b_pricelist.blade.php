...
<div class="container">
    <div class="row mt-3">
        <div class="col-lg-6 mx-auto">
            ...
            <h4 class="text-center my-0 py-0">Coffee Pricelist (B2B)</h4>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="swiper gb-slider position-relative rounded">
                                            <div class="swiper-wrapper">
                                                ...
                                                @empty
                                                <div class="swiper-slide" data-img="{{ asset('assets/images/products/no-image.png') }}" data-product="{{$value->name}}" data-index="0" data-images='["{{ asset('assets/images/products/noimages.png') }}"]'>
