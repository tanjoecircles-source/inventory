        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
                    <h4 class="text-white">Lupa Password?</h4>        
                </div>
            </div>
        </div>
    </div>
</div>
<form id="login-form" name="login-form" action="{{url('forgot-password-email')}}" method="POST" enctype="multipart/form-data" >
@csrf
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <div class="card no-border shadow-none custom-square mb-3">
                <div class="card-body p-0">
                    <div class="form-group">
                        <label class="form-label">Masukkan email terdaftar untuk melakukan pemulihan password</label>
...
<div id="bottom-bar" class="shadow-none">
    <div class="bg-white text-primary mt-2">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
                    <button type="submit" class="btn btn-primary btn-lg btn-block mb-3">Kirim Email</button>
                </div>
            </div>
        </div>
    </div>
