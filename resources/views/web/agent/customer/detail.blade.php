...
<x-header-white-3column>
    @slot('back')
    <x-back backstyle="text-dark" urlback="{{url('customer-store-list')}}"></x-back>
    @endslot
    @slot('notif')
        ...
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <div class="card no-border shadow-none custom-square mt-4 mb-3">
                <div class="card-body px-2 py-4">
                    <div class="form-group">
                        <p class="px-2 mb-2">Nama Pelanggan</p>
            ...
            <div class="card text-center no-border shadow-none custom-square mb-7">
                <div class="card-body p-0">
                    <a href="{{(url('customer-store-edit/'.$id))}}" class="d-flex p-4 border-bottom">
                        <i class="fe fe-edit fs-16 mr-2"></i>
                        <h6 class="mb-1 font-weight-semibold">Ubah Data</h6>
                    </a>
                    <a href="{{(url('customer-store-delete/'.$id))}}" data-title="{{$name}}" class="d-flex p-4 border-bottom btn-confirm">
