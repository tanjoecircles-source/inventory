            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-transaction" role="tabpanel" aria-labelledby="pills-transaction-tab">
                    ...
                    <div class="row mb-3 mt-3">
                        <div class="col-8 text-left text-mutes">Disetujui...</div>
                        ...
                        <div class="card-body px-3 py-3">
                            <div class="row">
                                <div class="col text-muted">
                                    <h6>Catatan:</h6>
                                    <p class="text-justify p-catatan">Proses Visitasi menunggu Scan Produk.
Jika dalam <span class="text-primary">4 Jam</span> Setelah Jadwal Visitasi tidak diproses, maka Proses Visitasi otomatis dibatalkan</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card no-border shadow-none custom-square my-2">
                        <div class="card-body px-3 py-3">
                            <div class="row">
                                <div class="col">
                                <a href="{{ url('qrcode-agent') }}" class="btn btn-primary btn-lg btn-block">
                                    <i class="fa fa-qrcode"></i> Scan Produk
                                </a>
                                </div>
                            </div>
                        </div>
