            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-transaction" role="tabpanel" aria-labelledby="pills-transaction-tab">
                    ...
                    <div class="row mb-3 mt-3">
                        <div class="col-8 text-left text-muted">Menunggu Konfirmasi...</div>
                        <div class="col text-right text-primary">29:58</div>
                    </div>
                        ...
                        <div class="card-body px-3 py-3">
                            <div class="row">
                                <div class="col text-muted">
                                    <h6>Catatan:</h6>
                                    <p class="text-justify p-catatan">Menunggu konfirmasi penjual. Jika dalam <span class="text-primary">30 menit</span> pengajuan tidak diproses, maka pengajuan otomatis dibatalkan</p>
                                </div>
                            </div>
                        </div>
                    </div>
