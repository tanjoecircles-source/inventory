        ...
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <div class="card no-border shadow-none custom-square mb-3">
                <div class="card-body py-3">
                    ...
                    <h5 class="mb-1 font-weight-bold text-primary">Resep Menu</h5>
            ...
            <div class="card no-border shadow-none custom-square mb-7">
                <div class="card-body p-0">
                    ...
                    <ul class="demo-accordion accordionjs m-0 custom-square">
                        <li class="custom-square acc_section">
                            <div class="acc_head"><h3>Filter Hot (Rasio 1:16)</h3></div>
                        ...
                        <li class="custom-square acc_section">
                            <div class="acc_head"><h3>Filter Iced (Rasio 1:16)</h3></div>
                            <div class="acc_content" style="display: none;">
                                <div class="px-4">
                                    <label class="font-weight-bold">Ingredient</label>
                                    <div class="d-flex border-bottom">
                    ...
                    <br><br>
                    <h5 class="text-left mx-4 my-2"><i>Espresso Liquid</i></h5>
                    <ul class="demo-accordion accordionjs m-0 custom-square">
                        <li class="custom-square acc_section">
                            <div class="acc_head"><h3>Basic Espresso (Rasio 1:2)</h3></div>
                            <div class="acc_content" style="display: none;">
                                <div class="px-4">
                                    <label class="font-weight-bold">Ingredient</label>
                                    <div class="d-flex border-bottom">
                                    ...
                                    <ol style="padding-left:14px">
                                        ...
                                        <li>Grinding Roasted Beans dengan grind size 0.7-1.2 (Mazzer)</li>
                        ...
                        <li class="custom-square acc_section">
                            <div class="acc_head"><h3>Basic Ristretto (Rasio 1:1)</h3></div>
                            <div class="acc_content" style="display: none;">
                                <div class="px-4">
                                    <label class="font-weight-bold">Ingredient</label>
                                    <div class="d-flex border-bottom">
                        ...
                        <li class="custom-square acc_section">
                            <div class="acc_head"><h3>Basic Lungo (Rasio 1:3)</h3></div>
                            <div class="acc_content" style="display: none;">
                                <div class="px-4">
                                    <label class="font-weight-bold">Ingredient</label>
                                    <div class="d-flex border-bottom">
                    ...
                    <ul class="demo-accordion accordionjs m-0 custom-square">
                        <li class="custom-square acc_section">
                            <div class="acc_head"><h3>Americano (Hot)</h3></div>
                            <div class="acc_content" style="display: none;">
                                <div class="px-4">
                                    <label class="font-weight-bold">Ingredient</label>
                                    <div class="d-flex border-bottom">
                                    ...
                                    <ol style="padding-left:14px">
                                        ...
                                        <li>Tuangkan 180 ml air panas ke dalam cangkir</li>
                                        <li>Selesai</li>
                                    </ol>
                                </div>
                            </div>
                        ...
                        <li class="custom-square acc_section">
                            <div class="acc_head"><h3>Americano (Iced)</h3></div>
                            <div class="acc_content" style="display: none;">
                                <div class="px-4">
                                    <label class="font-weight-bold">Ingredient</label>
                                    <div class="d-flex border-bottom">
                        ...
                        <li class="custom-square acc_section">
                            <div class="acc_head"><h3>Cappuchino/Magic (Hot)</h3></div>
                            <div class="acc_content" style="display: none;">
                                <div class="px-4">
                                    <label class="font-weight-bold">Ingredient</label>
                                    <div class="d-flex border-bottom">
                        ...
                        <li class="custom-square acc_section">
                            <div class="acc_head"><h3>Cappuchino/split (Hot)</h3></div>
                            <div class="acc_content" style="display: none;">
                                <div class="px-4">
                                    <label class="font-weight-bold">Ingredient</label>
                                    <div class="d-flex border-bottom">
                                        <div class="mr-auto text-left">
                                            <p class="my-1">Espresso Liquid</p>
                                        </div>
                                        <div class="ml-auto text-right">
                                            <p class="my-1">36 ml</p>
                                        </div>
                                    </div>
                                    <div class="d-flex border-bottom">
                                        <div class="mr-auto text-left">
                                        ...
                                        <div class="ml-auto text-right">
                                            <p class="my-1">130 ml</p>
                                        </div>
                                    </div>
                                    <label class="font-weight-bold pt-2">Method</label>
                                    <ol style="padding-left:14px">
                                        <li>Siapkan milk jug, cangkir espresso, cangkir white</li>
                                        <li>Siapkan freshmilk dan espresso (dalam 2 cangkir) yang sudah dibuat</li>
                                        <li>Tuang espresso ke dalam cangkir (1 single shoot untuk white)</li>
                                        <li>Tuang freshmilk ke dalam milkjug, steaming freshmilk</li>
                                        <li>Tuang dan pouring freshmilk steamed(hot) ke dalam cangkir berisi espresso</li>
                                        <li>Selesai</li>
                                    </ol>
                                </div>
                            </div>
                        ...
                        <li class="custom-square acc_section">
                            <div class="acc_head"><h3>Dirty Latte (Iced)</h3></div>
                            <div class="acc_content" style="display: none;">
                                <div class="px-4">
                                    <label class="font-weight-bold">Ingredient</label>
                                    <div class="d-flex border-bottom">
                                    ...
                                    <div class="d-flex border-bottom">
                                        ...
                                        <div class="ml-auto text-right">
                                            <p class="my-1">60 ml</p>
                                        </div>
                                    </div>
                                    <div class="d-flex border-bottom">
                                        <div class="mr-auto text-left">
                                            <p class="my-1">Diamond Rich Milk dingin</p>
                                        </div>
                                        <div class="ml-auto text-right">
                                            <p class="my-1">50 ml</p>
                                        </div>
                                    </div>
                                    <div class="d-flex border-bottom">
                                        <div class="mr-auto text-left">
                                    ...
                                    <ol style="padding-left:14px">
                                        ...
                                        <li>Siapkan freshmilk, diamond rich milk, creamer icehot, dan ristretto yang sudah dibuat</li>
                                        <li>Tuang freshmilk dan creamer icehot ke dalam gelas dingin (aduk)</li>
                                        <li>Tuang ristretto menggunakan sendok secara perlahan ke dalam gelas berisi mixed freshmilk, diamond rich milk& creamer</li>
                    ...
                    <br><br>
                    <h5 class="text-left mx-4 my-2"><i>Flavored Coffee</i></h5>
                    <ul class="demo-accordion accordionjs m-0 custom-square">
                        <li class="custom-square acc_section">
                            <div class="acc_head"><h3>Aceh Sanger (Hot)</h3></div>
                            <div class="acc_content" style="display: none;">
                                <div class="px-4">
                                    <label class="font-weight-bold">Ingredient</label>
                                    <div class="d-flex border-bottom">
                        ...
                        <li class="custom-square acc_section">
                            <div class="acc_head"><h3>Creamy Coffee (Iced)</h3></div>
                            <div class="acc_content" style="display: none;">
                                <div class="px-4">
                                    <label class="font-weight-bold">Ingredient</label>
                                    <div class="d-flex border-bottom">
                                    ...
                                    <div class="d-flex border-bottom">
                                        <div class="mr-auto text-left">
                                            <p class="my-1">freshmilk</p>
                                        </div>
                                        <div class="ml-auto text-right">
                                            <p class="my-1">75 ml</p>
                                        </div>
                                    </div>
                                    <div class="d-flex border-bottom">
                                        <div class="mr-auto text-left">
                                            <p class="my-1">Creamer Ice Hot</p>
                                        </div>
                                        <div class="ml-auto text-right">
                                            <p class="my-1">15 ml</p>
                                        </div>
                                    ...
                                    <div class="d-flex border-bottom">
                                        <div class="mr-auto text-left">
                                            <p class="my-1">Evaporasi</p>
                                        </div>
                                        <div class="ml-auto text-right">
                                            <p class="my-1">10 ml</p>
                                        </div>
                                    </div>
                                    <div class="d-flex border-bottom">
                                        <div class="mr-auto text-left">
                                    ...
                                    <ol style="padding-left:14px">
                                        ...
                                        <li>Siapkan freshmilk, creamer ice hot, evaporasi, dan lungo yang sudah dibuat</li>
                                        <li>Tuang es batu, freshmilk, creamer ice hot, evaporasi, dan 1/2 lungo (27 ml) ke dalam shaker</li>
                        ...
                        <li class="custom-square acc_section">
                            <div class="acc_head"><h3>Palm Coffee (Iced)</h3></div>
                            <div class="acc_content" style="display: none;">
                                <div class="px-4">
                                    <label class="font-weight-bold">Ingredient</label>
                                    <div class="d-flex border-bottom">
                                    ...
                                    <ol style="padding-left:14px">
                                        <li>Siapkan gelas</li>
                                        <li>Siapkan freshmilk, creamer ice hot, evaporasi, dan lungo yang sudah dibuat</li>
                                        <li>Tuang palm sugar, freshmilk, creamer ice hot, evaporasi,es batu, dan 1/2 lungo (27 ml) ke dalam gelas</li>
                                        <li>Selesai</li>
                                    </ol>
                                </div>
                            </div>
