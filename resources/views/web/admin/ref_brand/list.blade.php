    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <div class="d-flex justify-content-end mx-3">
                <a href="{{url('brand-add')}}" id="btn-float" class="shadow-sm">
            ...
            <div class="card no-border shadow-none custom-square mb-0">
                <div class="card-body pb-2 ">
                    ...
                    <h2 class="mb-1 font-weight-bold text-primary">Brand</h2>
                    <span class="mb-1 text-muted">For managing references Brand</span>
                </div>
            </div>
            <div class="card text-center no-border shadow-none custom-square mb-2">
                <div class="card-body p-2">
                    <form id="search-form" class="mb-2" name="search-form" action="{{url('brand-list')}}" method="GET">
            ...
            <div class="card text-center no-border shadow-none custom-square">
                <div class="card-body p-0">
                    <div id="content-data">
                        ...
                        @endif
                        @include('web.admin.ref_brand.paginate')
                    </div>
                </div>
            </div>
