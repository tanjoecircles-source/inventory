            ...
            <div class="card no-border shadow-none custom-square mt-4 mb-3">
                <div class="card-body px-2 py-4">
                    <div class="form-group">
                        <p class="px-2 mb-2">Nama Merek/Brand</p>
                        <h6 class="px-2 m-0 font-weight-bold">{{$name}}</h6>
                    </div>
                    <div class="form-group">
                        <p class="px-2 mb-2">Made in</p>
                        <h6 class="px-2 m-0 font-weight-bold">{{$factory}}</h6>
                    </div>
                </div>
            </div>
            <div class="card text-center no-border shadow-none custom-square mb-7">
                <div class="card-body p-0">
                    <a href="{{(url('brand-edit/'.$id))}}" class="d-flex p-4 border-bottom">
                        <i class="fe fe-edit fs-16 mr-2"></i>
                        <h6 class="mb-1 font-weight-semibold">Ubah Data</h6>
                    </a>
                    <a href="{{(url('brand-delete/'.$id))}}" data-title="{{$name}}" class="d-flex p-4 border-bottom btn-confirm">
