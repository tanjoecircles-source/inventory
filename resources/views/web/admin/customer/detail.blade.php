...
<x-header-white-3column>
    @slot('back')
    <x-back backstyle="text-dark" urlback="{{url('customer-list')}}"></x-back>
    @endslot
    @slot('notif')
        ...
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            ...
            <div class="card text-center no-border shadow-none custom-square mb-7">
                <div class="card-body p-0">
                    <a href="{{(url('customer-edit/'.$id))}}" class="d-flex p-4 border-bottom">
                        <i class="fe fe-edit fs-16 mr-2"></i>
                        <h6 class="mb-1 font-weight-semibold">Ubah Data</h6>
                    </a>
                    <a href="{{(url('customer-delete/'.$id))}}" data-title="{{$name}}" class="d-flex p-4 border-bottom btn-confirm">
