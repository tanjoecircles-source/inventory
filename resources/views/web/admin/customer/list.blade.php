    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <div class="d-flex justify-content-end mx-3">
                <a href="{{url('customer-add')}}" id="btn-float" class="shadow-sm">
            ...
            <div class="card no-border shadow-none custom-square mb-0">
                <div class="card-body p-4 py-4">
                    ...
                    <span class=" text-muted">For managing customer data</span>
                </div>
            </div>
            <div class="card text-center no-border shadow-none custom-square mb-2">
                <div class="card-body px-2 py-0">
                    <form id="search-form" class="mb-2" name="search-form" action="{{url('customer-list')}}" method="GET">
            ...
            <div class="card text-center no-border shadow-none custom-square">
                <div class="card-body p-0">
                    <div id="content-data">
                        ...
                        @endif
                        @include('web.admin.customer.paginate')
                    </div>
                </div>
            </div>
