        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
                <div class="d-flex justify-content-end mx-3">
                    <a href="{{url('purchasing-add')}}" id="btn-float" class="shadow-sm">
                ...
                <div class="card no-border shadow-none custom-square mb-0">
                    <div class="card-body px-2 py-3">
                        ...
                        <h4 class="mb-1 font-weight-bold text-primary">Belanja</h4>
                        <span class="mb-1 text-muted">For managing Purchasing</span>
                    </div>
                </div>
                <div class="card text-center no-border shadow-none custom-square mb-2">
                    <div class="card-body px-2 py-0">
                        <form id="search-form" class="mb-2" name="search-form" action="{{url('purchasing-list')}}" method="GET">
                ...
                <div class="panel text-center no-border shadow-none custom-square">
                    <div class="panel-body px-0 py-2">
                        <div id="content-data">
                            ...
                            @endif
                            @include('web.admin.purchasing.paginate')
                        </div>
                    </div>
                </div>
