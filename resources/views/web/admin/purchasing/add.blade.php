...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <form id="purchasing-form" name="purchasing-form" action="{{url('purchasing-create')}}" method="POST" enctype="multipart/form-data" >
            @csrf
            <div class="card no-border shadow-none custom-square mt-4 mb-3">
                <div class="card-body px-2 py-4">
                    ...
                    <div class="form-group">
                        <label class="form-label">Vendor <a href="{{url('vendor-add?purchasing=true')}}" class="btn-dark btn-sm pull-right mb-1"><i class="fe fe-plus-circle"></i> Tambah</a></label>
