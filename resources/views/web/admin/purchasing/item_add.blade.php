<x-layouts.app>
    <x-header-white-3column>
        @slot('back')
        <x-back backstyle="text-dark" urlback="{{url('sales-detail/'.$pur_id)}}"></x-back>
        @endslot
        @slot('notif')
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
                <form id="purchasing-item-form" name="purchasing-item-form" action="{{url('purchasing-item-create')}}" method="POST" enctype="multipart/form-data" >
                @csrf
