...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            ...
            @endif
            <form id="payment-form" name="payment-form" action="{{url('store-operational-pay/'.$detail->id)}}" method="POST" enctype="multipart/form-data" >
            @csrf
            <div class="card no-border shadow-none custom-square mt-4 mb-3">
                <div class="card-body px-2 py-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" class="form-control masked @error('op_payment') is-invalid @enderror" id="op_payment" name="op_payment" value="{{$detail->must_pay}}" readonly="true">
                        </div>
                        @error('op_payment')<div class="text-danger">{{ $message }}</div>@enderror
                    </div>
                </div>
...
$(document).ready(function () {
    ...
    $("#partial-pay").click(function(){
        $("#op_payment").removeAttr("readonly");
    }); 
    $("#full-pay").click(function(){
        $("#op_payment").addAttr("readonly");
    }); 
