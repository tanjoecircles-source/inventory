<x-layouts.app>
    <x-header-white-3column>
        @slot('back')
        <x-back backstyle="text-dark" urlback="{{url('store-operational-detail/'.$op_id)}}"></x-back>
        @endslot
        @slot('notif')
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
                <form id="store-operational-item-form" name="store-operational-item-form" action="{{url('store-operational-item-create')}}" method="POST" enctype="multipart/form-data" >
                @csrf
                ...
                <div class="card text-center no-border shadow-none custom-square mb-7">
                    <div class="card-body p-2">
                        ...
                        <a href="{{url('sales-detail/'.$op_id)}}" class="btn btn-dark btn-block btn-outline" id="btn-cancel" name="btn-cancel">Batal</a>
                    </div>
                </div>
                </form>
            </div>
