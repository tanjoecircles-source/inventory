...
<x-header-white-3column>
    @slot('back')
    <x-back backstyle="text-dark" urlback="{{url('store-operational-detail/'.$detail->itm_op_id)}}"></x-back>
    @endslot
    @slot('notif')
        ...
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <div class="card no-border shadow-none custom-square mt-4 mb-3">
                <div class="card-body px-2 py-4">
                    <div class="form-group">
                        ...
                        <h6 class="px-2 m-0 font-weight-bold">{{$detail->itm_product}}</h6>
                    </div>
                    <div class="form-group">
                        <p class="px-2 mb-2">Harga</p>
                        <h6 class="px-2 m-0 font-weight-bold">{{$detail->itm_price}}</h6>
                    </div>
                    <div class="form-group">
            ...
            <div class="card text-center no-border shadow-none custom-square mb-7">
                <div class="card-body p-0">
                    <a href="{{(url('store-operational-item-delete/'.$detail->id.'?op='.$detail->itm_op_id))}}" data-title="{{$detail->itm_product}}" class="d-flex p-4 border-bottom btn-confirm">
