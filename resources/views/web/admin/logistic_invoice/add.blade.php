...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <form id="logistic-form" name="logistic-form" action="{{url('logistic-create')}}" method="POST" enctype="multipart/form-data" >
            @csrf
            <div class="card no-border shadow-none custom-square mt-4 mb-3">
                <div class="card-body px-2 py-4">
                    <div class="form-group">
                        <label class="form-label">Kode Invoice</label>
                        <input type="text" class="form-control @error('inv_code') is-invalid @enderror" name="inv_code" value="{{ old('inv_code') }}" placeholder="Tulis Kode Invoice">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control fc-datepicker" name="inv_date" value="{{old('inv_date')}}" type="text" placeholder="dd-mm-yyyy">
                        </div>
                        @error('inv_date')<div class="text-danger">{{ $message }}</div>@enderror
                    </div>
                    <div class="form-group">
                        <label class="form-label">Vendor</label>
                        <input type="text" class="form-control @error('inv_source') is-invalid @enderror" name="inv_source" value="{{ old('inv_source') }}" placeholder="Tulis Nama PT, CV atau Perorangan">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" class="form-control masked" name="inv_total" id="inv_total" value="{{ old('inv_total') }}">
                        </div>
