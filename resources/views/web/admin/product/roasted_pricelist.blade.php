                                    ...
                                    <div class="col-sm-5">
                                        <div class="swiper gb-slider position-relative rounded">
                                            <div class="swiper-wrapper">
                                                ...
                                                @empty
                                                <div class="swiper-slide" data-img="{{ asset('assets/images/products/noimage.png') }}" data-product="{{$value->name}}" data-index="0" data-images='["{{ asset('assets/images/products/noimage.png') }}"]'>
