        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
                    <form id="product-photo-form" name="product-photo-form" action="{{url('product-update-photo/'.$id)}}" method="POST" enctype="multipart/form-data" >
                    @csrf
                    <div class="card no-border shadow-none custom-square mb-0">
                        <div class="card-body px-3 pb-0">
                            ...
                            <div class="row">
                                <div class="col px-1">
                                    <div class="form-group text-center">
                                        <input type="file" name="photo_exterior_front" class="uploader" data-height="100" data-default-file="{{$detail->photo_exterior_front}}" />
                                ...
                                <div class="col px-1">
                                    <div class="form-group text-center">
                                        <input type="file" name="photo_exterior_right" class="uploader" data-height="100" data-default-file="{{$detail->photo_exterior_right}}" />
                            ...
                            <div class="row">
                                <div class="col px-1">
                                    <div class="form-group text-center">
                                        <input type="file" name="photo_exterior_left" class="uploader" data-height="100" data-default-file="{{$detail->photo_exterior_left}}"/>
                                ...
                                <div class="col px-1">
                                    <div class="form-group text-center">
                                        <input type="file" name="photo_exterior_back" class="uploader" data-height="100" data-default-file="{{$detail->photo_exterior_back}}"/>
                    ...
                    <div class="card text-center no-border shadow-none custom-square mb-7">
                        <div class="card-body py-3 px-2">
                            <div class="row">
                                <div class="col">
                                    <a href="{{url('product-edit-category/'.$id)}}" class="btn btn-outline-primary btn-block btn-lg" id="btn-back" name="btn-back">Batal</a>
                                </div>
                                <div class="col">
