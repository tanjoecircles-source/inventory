...
<x-header-white-3column>
    @slot('back')
    <x-back backstyle="text-dark" urlback="{{url('roasting-detail/'.$detail->id)}}"></x-back>
    @endslot
    @slot('notif')
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            ...
            @endif
            <form id="payment-form" name="payment-form" action="{{url('roasting-pay/'.$detail->id)}}" method="POST" enctype="multipart/form-data" >
            @csrf
            <div class="card no-border shadow-none custom-square mt-4 mb-3">
                <div class="card-body px-2 py-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" class="form-control masked @error('inv_payment') is-invalid @enderror" id="inv_payment" name="inv_payment" value="{{$detail->must_pay}}" readonly="true">
                        </div>
                        @error('inv_payment')<div class="text-danger">{{ $message }}</div>@enderror
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col">
                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="inv_payment_type" id="Transfer" value="Transfer" checked>
                                    <span class="custom-control-label">Transfer</span>
                                </label>
                            </div>
                            <div class="col">
                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="inv_payment_type" id="Cash" value="Cash">
...
$(document).ready(function () {
    ...
    $("#partial-pay").click(function(){
        $("#inv_payment").removeAttr("readonly");
    }); 
    $("#full-pay").click(function(){
        $("#inv_payment").addAttr("readonly");
    }); 
