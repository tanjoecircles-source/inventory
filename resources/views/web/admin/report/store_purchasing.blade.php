...
<style>
    ...
    .bg-purple-transparent { background-color: rgba(111, 66, 193, 0.1); color: #6f42c1; }
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-10 mx-auto">
            ...
            <div class="d-flex align-items-center mb-4 mt-4">
                <div class="mr-auto">
                    <h4 class="mb-1 font-weight-bold">Laporan Belanja Kedai</h4>
                    <p class="text-muted mb-0">Analisa pengeluaran stok operasional</p>
                </div>
                <div class="ml-auto">
                    ...
                    <div class="card shadow-sm card-dashboard h-80">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center mb-3">
                                <div class="icon-box bg-blue-transparent mr-3">
                                    <i class="fe fe-shopping-cart fs-24"></i>
                                </div>
                                <div>
                                    <h6 class="text-muted mb-0 fs-12 text-uppercase font-weight-bold">Total Belanja Periode Ini</h6>
                ...
                <div class="col-6 col-md-3">
                    <div class="card shadow-sm card-dashboard h-80">
                        <div class="card-body p-3 text-center">
                            <div class="icon-box bg-purple-transparent mx-auto mb-3">
                                <i class="fe fe-file-text fs-20"></i>
                            </div>
                            <h6 class="text-muted mb-1 fs-11 text-uppercase font-weight-bold">Transaksi</h6>
                            <h5 class="font-weight-bold mb-0">{{$current_count}} <small class="text-muted">Nota</small></h5>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="card shadow-sm card-dashboard h-80">
                        <div class="card-body p-3 text-center">
                            ...
                            <h6 class="text-muted mb-1 fs-11 text-uppercase font-weight-bold">Avg / Transaksi</h6>
            ...
            <div class="card no-border shadow-sm custom-square">
                <div class="card-header bg-white py-3">
                    <h6 class="mb-0 font-weight-bold"><i class="fe fe-list mr-2"></i>Daftar Pengeluaran Stok</h6>
                </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                @if(count($contents) > 0)
                                    ...
                                    <tr>
                                        <td>
                                            <div class="font-weight-bold text-primary">{{$it->pur_code}}</div>
                                            <div class="fs-12 text-muted">{{$it->vendor_name}}</div>
                                        </td>
                                        <td class="text-center">
                                            <div class="fs-13">{{date('d M Y', strtotime($it->pur_date))}}</div>
                                        </td>
                                        <td class="text-right">
                                            <div class="font-weight-bold text-dark">Rp {{number_format($it->pur_total, 0, ',', '.')}}</div>
                                        </td>
                                        <td class="text-right">
                                            @if($it->pur_status_payment == 'Lunas')
                                ...
                                @else
                                    <tr>
                                        <td colspan="4" class="text-center py-5">
                                            ...
                                            <p class="text-muted">Tidak ada data belanja ditemukan</p>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
