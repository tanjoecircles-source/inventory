                ...
                <div class="card-body py-2 px-4">
                    <div class="d-flex title-bar py-1">
                        <div class="mr-auto text-left">
                            <h5 class="mb-1 font-weight-bold text-dark">Profit</h5>
                            <span class="mb-1 text-muted">Toko Kopi</span>
                        </div>
                        <div class="ml-auto text-right">
                            <h3 class="mb-1 font-weight-bold text-gray pull-right">Rp {{str_replace(",", ".", number_format($profit))}}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card no-border shadow-none custom-square mt-2">
                <div class="card-body py-2 px-4">
                    ...
                    <div class="d-flex title-bar py-1">
                        ...
                        <div class="ml-auto text-right">
                            <p class="mb-0">Rp {{str_replace(",", ".", number_format($cash))}}</p>
                        </div>
                    </div>
                    <div class="d-flex title-bar py-1 border-top">
                        ...
                        <div class="ml-auto text-right">
                            <p class="mb-0">Rp {{str_replace(",", ".", number_format($qris))}}</p>
                        </div>
                    </div>
                    <div class="d-flex title-bar py-1 border-top">
                        <div class="mr-auto text-left">
                        ...
                        <div class="ml-auto text-right">
                            <p class="mb-0 font-weight-bold">Rp {{str_replace(",", ".", number_format($income_total))}}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card no-border shadow-none custom-square mt-2">
                <div class="card-body py-2 px-4">
                    ...
                    <div class="d-flex title-bar py-1">
                        ...
                        <div class="ml-auto text-right">
                            <p class="mb-0">Rp {{str_replace(",", ".", number_format($spending))}}</p>
                        </div>
                    </div>
                    <div class="d-flex title-bar py-1 border-top">
                        <div class="mr-auto text-left">
                    ...
                    <div class="d-flex title-bar py-1 border-top">
                        ...
                        <div class="ml-auto text-right">
                            <p class="mb-0">Rp {{str_replace(",", ".", number_format($operational))}}</p>
                        </div>
                    </div>
                    
                    <div class="d-flex title-bar py-1 border-top">
                        <div class="mr-auto text-left">
                            <p class="mb-1">Fee Staf <span class="text-danger fs-12">{{$staff_fee_desc}}</span></p>
                        </div>
                        <div class="ml-auto text-right">
                            <p class="mb-0">Rp {{str_replace(",", ".", number_format($staff_fee))}}</p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex title-bar py-1 border-top">
                        ...
                        <div class="ml-auto text-right">
                            <p class="mb-0 font-weight-bold">Rp {{str_replace(",", ".", number_format($outcome_total))}}</p>
                        </div>
                    </div>
                </div>
            </div>
