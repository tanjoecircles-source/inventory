...
<x-header-white-3column>
    @slot('back')
    <x-back backstyle="text-dark" urlback="{{url('share-profit-detail/'.$id)}}"></x-back>
    @endslot
    @slot('notif')
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <form id="share-profit-pay-form" name="share-profit-pay-form" action="{{url('share-profit-spending-create/'.$id)}}" method="POST" enctype="multipart/form-data" >
            @csrf
