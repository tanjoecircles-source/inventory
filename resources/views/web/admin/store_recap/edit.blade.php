...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <form id="store-recap-form" name="store-recap-form" action="{{url('store-recap-update/'.$detail->id)}}" method="POST" enctype="multipart/form-data" >
            @csrf
            <div class="card no-border shadow-none custom-square mt-4 mb-3">
                <div class="card-body px-2 py-4">
                    ...
                    <div class="form-group">
                        <div class="row ">
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control masked @error('income_qris') is-invalid @enderror" name="income_qris" id="income_qris" value="{{ $detail->income_qris }}" readonly >
                                @error('income_qris')<div class="text-danger">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-6">
                                <label class="form-label">Cash</label>
                                <input type="text" class="form-control masked @error('income_cash') is-invalid @enderror" name="income_cash" id="income_cash" value="{{ $detail->income_cash }}" readonly >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control masked @error('income_total') is-invalid @enderror" name="income_total" id="income_total" value="{{ $detail->income_total }}" readonly >
                    ...
                    <div class="form-group">
                        <div class="row ">
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control masked @error('outcome_cash') is-invalid @enderror" name="outcome_cash" id="outcome_cash" value="{{ $detail->outcome_cash }}" readonly >
                                @error('outcome_cash')<div class="text-danger">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-6">
                                <label class="form-label">Belanja Stok</label>
                                <input type="text" class="form-control masked @error('outcome_purchasing') is-invalid @enderror" name="outcome_purchasing" id="outcome_purchasing" value="{{ $detail->outcome_purchasing }}" readonly >
                    ...
                    <div class="form-group">
                        <div class="row ">
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control masked @error('outcome_operational') is-invalid @enderror" name="outcome_operational" id="outcome_operational" value="{{ $detail->outcome_operational }}" readonly >
                                @error('outcome_operational')<div class="text-danger">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-6">
                                <label class="form-label">Gaji Barista</label>
                                <input type="text" class="form-control masked @error('outcome_barista') is-invalid @enderror" name="outcome_barista" id="outcome_barista" value="{{ $detail->outcome_barista }}" readonly >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control masked @error('outcome_total') is-invalid @enderror" name="outcome_total" id="outcome_total" value="{{ $detail->outcome_total }}" readonly >
