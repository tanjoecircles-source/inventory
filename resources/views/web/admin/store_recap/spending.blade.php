...
<x-header-white-3column>
    @slot('back')
    <x-back backstyle="text-dark" urlback="{{url('store-recap-detail/'.$id)}}"></x-back>
    @endslot
    @slot('notif')
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <form id="store-recap-pay-form" name="store-recap-pay-form" action="{{url('store-recap-spending-create/'.$id)}}" method="POST" enctype="multipart/form-data" >
            @csrf
