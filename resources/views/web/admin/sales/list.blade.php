            ...
            <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
                ...
                <div class="card no-border shadow-none custom-square mb-0">
                    <div class="card-body px-2 py-3">
                        ...
                        <span class="mb-1 text-muted">To Manage Green & Roasted Bean Sales</span>
                    </div>
                </div>
                <div class="card no-border shadow-none custom-square mb-2">
                    <div class="card-body px-2 py-0">
                        <form id="search-form" class="mb-2" name="search-form" action="{{url('sales-list')}}" method="GET">
                            <div class="d-flex">
                                <div class="p-2">
                ...
                <div class="panel panel-primary mb-0">
                    <div class="panel-body px-2 py-0">
                        ...
                        <a class="btn btn-dark btn-sm btn-block" href="{{url('sales-list')}}" class="active">Faktur</a></li>
                        </div>
                        <div class="col-6 px-1">
                        <a class="btn btn-outline-dark btn-sm btn-block" href="{{url('sales-list-paid')}}">Arsip</a></li>
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div class="panel text-center no-border shadow-none custom-square">
                    <div class="panel-body px-0 py-2">
                        <div id="content-data">
                            ...
                            @endif
                            @include('web.admin.sales.paginate')
                        </div>
                    </div>
                </div>
