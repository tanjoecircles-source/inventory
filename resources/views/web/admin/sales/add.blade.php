...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <form id="sales-form" name="sales-form" action="{{url('sales-create')}}" method="POST" enctype="multipart/form-data" >
            @csrf
            <div class="card no-border shadow-none custom-square mt-4 mb-3">
                <div class="card-body px-2 py-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('inv_code') is-invalid @enderror" name="inv_code" value="{{$inv_code}}" placeholder="Tulis Kode Invoice">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control fc-datepicker" name="inv_date" value="{{$date}}" type="text" placeholder="dd-mm-yyyy">
                        </div>
                        @error('inv_date')<div class="text-danger">{{ $message }}</div>@enderror
                    </div>
                    <div class="form-group">
                        <label class="form-label">Pelanggan</label>
                        <select class="form-control @error('inv_cust') is-invalid @enderror" name="inv_cust" id="inv_cust" placeholder="Pilih Customer">
                            @foreach($customer as $value)
                                @if(old('inv_cust') == $value->id)
                    ...
                    <div class="form-group">
                    <a href="{{url('customer-add?sales=true')}}" class="btn-dark btn-sm"><i class="fe fe-plus-circle"></i> Pelanggan</a>
                    </div>
                </div>
            </div>
