...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <form id="product-type-form" name="product-type-form" action="{{url('variant-update/'.$id)}}" method="POST" enctype="multipart/form-data" >
            @csrf
            <div class="card no-border shadow-none custom-square mt-4 mb-3">
                <div class="card-body px-2 py-4">
                    <div class="form-group">
                        <label class="form-label">Tipe Produk</label>
                        <select class="form-control" name="product_type" id="brand" placeholder="Pilih Brand">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" value="{{$name}}" placeholder="Cth: varian G, Varian E, RS ...">
