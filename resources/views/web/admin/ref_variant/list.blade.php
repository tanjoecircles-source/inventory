    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <div class="d-flex justify-content-end mx-3">
                <a href="{{url('variant-add')}}" id="btn-float" class="shadow-sm">
            ...
            <div class="card no-border shadow-none custom-square mb-0">
                <div class="card-body pb-2 px-2">
                    <div class="row">
                        <div class="col-8">
                            <h3 class="mb-1 font-weight-bold text-primary">Varian Produk</h3>
                            <span class="mb-1 text-muted">Untuk mengatur varian produk</span>
                        </div>
                        <div class="col-4">
            ...
            <div class="card text-center no-border shadow-none custom-square mb-2">
                <div class="card-body p-2">
                    <form id="search-form" class="mb-2" name="search-form" action="{{url('variant-list')}}" method="GET">
            ...
            <div class="card text-center no-border shadow-none custom-square">
                <div class="card-body p-0">
                    <div id="content-data">
                        ...
                        @endif
                        @include('web.admin.ref_variant.paginate')
                    </div>
                </div>
            </div>
