...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8 mx-auto">
            <form id="product-parent-form" name="product-parent-form" action="{{url('product-parent-update/'.$id)}}" method="POST" enctype="multipart/form-data" >
            @csrf
                ...
                <div class="card-body px-2 py-4">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('type') is-invalid @enderror" name="type" id="type" placeholder="Pilih Kategori">
                            ...
                            <option value="Roasted Filter" {{($type == 'Roasted Filter') ? 'selected' : ''}}>Roasted Filter</option>
                            <option value="Roasted Espresso" {{($type == 'Roasted Espresso') ? 'selected' : ''}}>Roasted Espresso</option>
                        </select>
                        ...
                        <div class="row">
                            <div class="col">
                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="status" id="status-active" value="Aktif" {{($status == 'Aktif') ? 'checked' : ''}}>
                                    <span class="custom-control-label">Aktif</span>
                                </label>
                            </div>
                            <div class="col">
                                <label class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="status" id="status-inactive" value="Tidak Aktif" {{($status == 'Tidak Aktif') ? 'checked' : ''}}>
